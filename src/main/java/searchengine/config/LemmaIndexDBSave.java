...
@Slf4j
@Component
public class LemmaIndexDBSave extends RecursiveAction {
    ...
    @Autowired
    public LemmaIndexDBSave(PageService pageService,
    ...
    public synchronized void compute() {
        ...
        elements.forEach(element -> {
            ...
            if ((pageService.getPageByPathAndSite(pagePath, site) == null && !link.equals(site.getUrl()))) {
                ...
                LemmaIndexDBSave task = new LemmaIndexDBSave(pageService, lemmaService, indexService,
                        siteService);
